  ...
  <div class="relative isolate px-6 pt-14 lg:px-8">
    ...
    <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
      ...
      <div class="text-center">
        ...
        <p class="mt-6 text-lg leading-8 text-gray-100">Start now with a fully fuctional API for link shrinking ready for intense usage. You can register in less than a minute.</p>
